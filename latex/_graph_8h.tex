...
\begin{DoxyCompactList}\small\item\em For this specific project, a vertex\textquotesingle{}s info is just the identifier of each vertex, and each vertex represents a location. \end{DoxyCompactList}\item 
class \mbox{\hyperlink{class_edge}{Edge$<$ T $>$}}
\begin{DoxyCompactList}\small\item\em For this specific project, an edge represents the distance between two locations(vertexes) \end{DoxyCompactList}\item 
